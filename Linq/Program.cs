...
namespace Linq
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //JoinLinq(categories, products);


        }

        private static void JoinLinq(List<Category> categories, List<Product> products)
        {
        ...
        {
            var result = products.FindAll(p => p.ProductName.Contains("Hp"));
